                        ...
                        <div class="footer-contact">
                            <div class="brand-logo">
                                <a href="index.htm" class="footer-logo float-start">
                                    <img src="../assets/images/brocade-logo.png" class="f-logo img-fluid blur-up lazyload"
                                        alt="logo">
                                </a>
                            </div>
                            <ul class="contact-lists" style="clear:both;">
                                <li>
                                    <span><b>phone:</b> <span class="font-light"> 014254687</span></span>
                                </li>
                                <li>
                                    <span><b>Address:</b><span class="font-light">Jhamsikhel,Lalitpur,Nepal</span></span>
                                </li>
                                <li>
                                    <span><b>Email:</b><span class="font-light">brocade@gmail.com</span></span>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="sub-footer">
            <div class="container">
                <div class="row gy-3">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="javascript:void(0)">
                                    <img src="../assets/images/payment-icon/1.png" style="height:80px"class="img-fluid blur-up lazyload"
                                        alt="payment icon">
                                </a>
                            </li>
                    ...
                    <div class="col-md-6">
                        <p class="mb-0 font-dark">© 2023, Brocade</p>
                    </div>
                </div>
            </div>
        </div>
